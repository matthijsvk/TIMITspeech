...
def generate_masks(inputs, valid_frames=None, batch_size=1, max_length=1000,
                   logger=logger_GeneralTools):  # inputs = X. valid_frames = list of frames when we need to extract the phoneme
